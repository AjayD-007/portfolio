      ...
      <Container maxWidth="7xl">
        <Card variant="nav">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            {viewCount !== null ? (
              <div
                className="flex items-center gap-1.5 md:gap-2 text-xs md:text-sm font-medium text-black dark:text-white bg-black/5 dark:bg-white/10 backdrop-blur-md px-2.5 md:px-4 py-1.5 md:py-3 rounded-full border border-black/10 dark:border-white/20 transition-all duration-500 animate-in fade-in zoom-in-95 hover:scale-105"
                title="Unique Views"
              >
